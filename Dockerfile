...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install --no-install-recommends python3 python3-pip git curl ca-certificates ssl-cert ffmpeg libsndfile1 -y
