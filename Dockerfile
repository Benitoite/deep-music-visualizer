...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install --no-install-recommends llvm python3 python3-pip python3-setuptools git curl ca-certificates ssl-cert ffmpeg libsndfile1 -y
